...
#' @param cols The column that needs to be converted into snakecase
#'
#' @return A data frame
...
#' Convert the metabolite long format into wide format
#'
...
#'
#' @return A recipe with specifications
...
#'
#' @param workflow_fittet_model The model workflow object that has been fitted
#'
#' @return A dataframe

tidy_model_output <- function(workflow_fittet_model){
  workflow_fittet_model %>%
